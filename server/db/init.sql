...
-- -----------------------------------------------------
-- Table `pm`.`d_project_deploy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pm`.`d_project_deploy` ;

CREATE TABLE IF NOT EXISTS `pm`.`d_project_deploy` (
...
-- Table `pm`.`d_deploy`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pm`.`d_deploy` ;

CREATE TABLE IF NOT EXISTS `pm`.`d_deploy` (
)
ENGINE = InnoDB;
